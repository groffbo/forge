  ...
  return (
    <div className="fixed right-0 z-0 h-full w-1/2 scale-x-[-1]">
      <div className="bg-contact-gradient flex h-full flex-col justify-between">
        ...
        <Shield className="seOnly:mb-10 seWidth:w-[100px] iPadMini:mb-20 iPadMini:w-[150px] iPadPro:mb-20 iPadPro:block iPadPro:w-[200px] tall:mb-20 taller:mb-40 left-0 mb-7 w-[150px] md:w-[200px] lg:hidden" />
      </div>
    </div>
  );
}
