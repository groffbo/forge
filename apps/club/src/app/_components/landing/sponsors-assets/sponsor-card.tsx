...
export default function SponsorCard({
  ...
  return (
    ...
    >
      <div className="relative flex h-44 w-28 flex-col justify-between rounded-[calc(1.5rem-3px)] bg-blue-950 p-4 transition-colors duration-300 group-hover:bg-blue-900 md:h-56 md:w-48">
