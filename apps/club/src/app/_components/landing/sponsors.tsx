...
export default function Sponsors() {
  ...
  return (
    ...
    >
      <h2
        ref={headerRef}
        className="font-pragati pt-32 pb-24 md:pt-12 md:pb-32 text-2xl font-bold leading-tight tracking-tight text-white [text-shadow:0px_0px_40px_#6B21A8,0px_0px_20px_#6B21A8,0px_0px_10px_#6B21A8] md:text-5xl lg:text-6xl"
      >
