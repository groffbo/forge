...
export default function Tracks() {
  return (
    <div id="tracks" className="my-2 sm:my-3 md:my-4 lg:my-6 xl:my-8 flex flex-col items-center space-y-1 sm:space-y-2 md:space-y-3 lg:space-y-4 overflow-x-hidden z-10 mb-4 sm:mb-6 md:mb-8 lg:mb-12 xl:mb-16">
