        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
                <DialogHeader className="flex flex-col">
                    ...
                    {(hacker.isFirstTime || hacker.agreesToReceiveEmailsFromMLH || hacker.foodAllergies) ? (
                        <div className="inline-flex flex-row gap-2 justify-center">
                            {hacker.foodAllergies && 
                            <Badge className="bg-red-800 text-white order-1 text-center my-auto">
                                FOOD RESTRICTIONS
                            </Badge>}
                            {hacker.agreesToReceiveEmailsFromMLH && 
                            <Badge className="bg-blue-800 text-white order-2 text-center my-auto">
                                MLH EMAILS
                            </Badge>}
                            {hacker.isFirstTime && <Badge className="bg-purple-800 text-white order-3 text-center my-auto">
                                FIRST TIME HACKER
                            </Badge>}
                        </div>
                    ) : null}
