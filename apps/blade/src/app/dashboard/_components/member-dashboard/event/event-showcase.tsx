    ...
    <Card>
      ...
      <CardHeader>
        <div className="flex flex-col items-start justify-between sm:flex-row">
          ...
          <Badge
            className={`${getTagColor(mostRecent.tag)} order-1 my-auto mb-1 sm:order-2 sm:mb-auto`}
          >
            {mostRecent.tag}
          </Badge>
        </div>
                ...
                <Card key={event.id}>
                  <CardHeader>
                    <div className="flex flex-col items-start justify-between sm:flex-row">
                      ...
                      <Badge
                        className={`${getTagColor(event.tag)} order-1 my-auto mb-1 sm:order-2 sm:mb-auto`}
                      >
                        {event.tag}
                      </Badge>
                    </div>
